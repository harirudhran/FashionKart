...
<body>
	...
	<nav class="navbar">
		<div class="nav-links">
			<a href="index.jsp">Home</a> <a href="shop.jsp?category=1">Men</a> <a
				href="shop.jsp?category=2">Women</a> <a href="shop.jsp?category=3">Kids</a>
		...
		<div class="nav-icons">
			...
			<% if (currentUser != null) { %>
			<a href="account.jsp" title="My Account"
				style="font-size: 14px; text-transform: uppercase; font-weight: bold; color: var(--primary-green);">Hi,
				<%= currentUser.getFirstName() %></a> <a href="LogoutServlet"
				title="Logout"><i class="fas fa-sign-out-alt"></i></a>
			<% } else { %>
			<a href="login.jsp" title="Login / Register"><i
		...
		<div class="product-grid">
			...
			<div class="product-card">
				...
				<a href="product.jsp?id=<%= p.getProductId() %>"
					class="product-image-container" style="display: block;"> <img
					src="images/<%= p.getImageUrl() %>" alt="<%= p.getName() %>"
			...
			<p
				style="text-align: center; grid-column: 1/-1; font-size: 18px; color: #777;">No
				products found in this category.</p>
			<% } %>
		</div>
	</div>
